...
install_marzban_script() {
    ...
    SCRIPT_URL="https://github.com/kawe0/Marzban/raw/master/marzban.sh"
...
install_marzban() {
    ...
    # Fetch releases
    FILES_URL_PREFIX="https://raw.githubusercontent.com/kawe0/Marzban/master"
    ...
    if [ "$marzban_version" == "latest" ]; then
        sed -i "s|image: kawe0/ma:.*|image: kawe0/ma:ma|g" "$docker_file_path"
    else
        sed -i "s|image: kawe0/ma:.*|image: kawe0/ma:${marzban_version}|g" "$docker_file_path"
    fi
